...
//	Sts_E = AvCodec.Open("C:/tmp/sample-15s.mp3", "", "--A_BASEFN=C:/tmp/AudioOut;--A_NBCHNL=2;--A_LAYOUT=3;--A_RATE=48000;--A_BPS=16;--A_FMT=WAV");
	Sts_E = AvCodec.Open("C:/tmp/Sample24bit96kHz5.1.wav", "", "--A_BASEFN=C:/tmp/AudioOut;--A_NBCHNL=6;--A_LAYOUT=0x3F;--A_RATE=48000;--A_BPS=16;--A_FMT=WAV;--A_CHUNK;--A_SPLIT");
	//Sts_E = AvCodec.Open("C:/tmp/Sample24bit96kHz5.1.wav", "", "--A_BASEFN=C:/tmp/AudioOut;--A_NBCHNL=6;--A_LAYOUT=0x3F;--A_RATE=48000;--A_BPS=16;--A_FMT=WAV;--A_CHUNK");
